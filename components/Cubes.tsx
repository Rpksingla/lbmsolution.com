...
// CREDIT
// Component inspired by Can Tastemel's original work for the lambda.ai landing page
// https://cantastemel.com
// Source: https://reactbits.dev/animations/cubes (JavaScript + CSS variant)
// Adapted to TypeScript; structural CSS lives in app/globals.css (repo convention:
// one stylesheet, token-driven) instead of a sibling Cubes.css import.
...
export default function Cubes({
  ...
  const simPosRef = useRef<Vec>({ x: 0, y: 0 });
  const simTargetRef = useRef<Vec>({ x: 0, y: 0 });
  ...
  }, [autoAnimate, gridSize, tiltAt, idleSpeed]);
