...
// SideRays background, from reactbits.dev (JavaScript + CSS variant, OGL/WebGL),
// adapted to TypeScript and re-themed to the LBM palette (accent purples).
// Repo convention: structural CSS lives in app/globals.css (.side-rays-container),
// NOT a sibling SideRays.css import. Decorative only; the caller (LpBackground)
// gates mounting on reduced-motion + wide viewport.
